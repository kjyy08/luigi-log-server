package cloud.luigi99.blog.content.post.adapter.out.persistence.jpa.post
        ...
        Given("JPA 엔티티가 주어졌을 때") {
            val entity =
                PostJpaEntity.from(
                    ...
                    body = "JPA 본문",
                    type = ContentType.BLOG,
                    status = cloud.luigi99.blog.content.post.domain.post.vo.PostStatus.DRAFT,
                )
            ...
            When("도메인 모델로 변환하면") {
                ...
                Then("모든 필드가 정확하게 매핑되어야 한다") {
                    ...
                    domain.status shouldBe cloud.luigi99.blog.content.post.domain.post.vo.PostStatus.DRAFT
                }
